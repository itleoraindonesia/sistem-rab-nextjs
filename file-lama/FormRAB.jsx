...
export default function FormRAB() {
  ...
  // Use custom hooks
  const { hasil, calculateRAB } = useRABCalculation(
    panels,
    ongkir,
    parameters,
    masterLoading
  ...
  const {
    ...
    loadExistingData,
    tambahBidang,
  } = useRABForm(id, panels, hasil, parameters);
  ...
  }, [watchedValues, panels, ongkir, parameters, masterLoading, calculateRAB]);
        ...
        <div className='bg-white rounded-xl shadow-lg p-6 w-full max-w-md text-center'>
          ...
          <div className='flex gap-3'>
            <button
              ...
              className='bg-brand-primary hover:bg-brand-dark text-white px-4 py-2 rounded-lg'
            >
              Coba Lagi
            </button>
            <button
    ...
    return (
      <div className='min-h-screen bg-gray-50 flex items-center justify-center p-4'>
        <div className='bg-white rounded-xl shadow-lg p-6 w-full max-w-md text-center'>
          ...
          <h3 className='text-lg font-medium text-gray-900'>Memuat data...</h3>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      if (e.target.value === "approved") {
                        ...
                        if (!confirmed) {
                          setValue("status", watchedValues.status || "");
                          return;
                        }
                      }
              ...
              {hasil ? (
                <div className='p-4 space-y-4'>
                          ...
                          <div className='bg-blue-50 p-4 rounded-lg border border-blue-200'>
                            ...
                            <div className='space-y-2'>
                              ...
                              <div className='border-t pt-2 flex justify-between font-semibold text-blue-800'>
                                ...
                                <span>
                                  {formatRupiah(hasil.subtotalDinding)}
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className='bg-green-50 p-4 rounded-lg border border-green-200'>
                            ...
                            <div className='space-y-2'>
                              ...
                              <div className='border-t pt-2 flex justify-between font-semibold text-green-800'>
                                ...
                                <span>
                                  {formatRupiah(hasil.subtotalLantai)}
                                </span>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className='border-t pt-3 flex justify-between font-bold text-lg text-brand-primary'>
                    <span>Total</span>
                    <span>{formatRupiah(hasil.grandTotal)}</span>
                  </div>
                </div>
              ) : (
