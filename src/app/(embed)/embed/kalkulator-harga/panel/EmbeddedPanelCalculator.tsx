...
import { usePanelCalculator, usePanelCalculatorProps } from "@/hooks/usePanelCalculator";
...
interface EmbeddedPanelCalculatorProps {
  initialPanels?: Panel[];
  initialOngkir?: Ongkir[];
...
export default function EmbeddedPanelCalculator({
  ...
  initialOngkir,
  initialProvinsiList,
}: EmbeddedPanelCalculatorProps) {
  const calculatorProps: usePanelCalculatorProps = {
  ...
  } = usePanelCalculator(calculatorProps);
                  ...
                  render={({ field }) => (
                    <div>
                      ...
                      >
                        ...
                        {[...new Set(ongkir.map((o: Ongkir) => o.provinsi))].map(
                          (provinsi) => (
