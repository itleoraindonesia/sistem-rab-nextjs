...
export default function KalkulatorInteriorPage() {
  return (
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            <div className="w-24 h-24 mx-auto mb-6 bg-yellow-100 rounded-full flex items-center justify-center">
              <Sofa className="w-12 h-12 text-yellow-600" />
            </div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Kalkulator Interior</h2>
            <p className="text-gray-600 mb-6">
              Perhitungan furniture custom, plafon, dan finishing.
            </p>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-left">
              <h3 className="font-medium text-yellow-800 mb-2">Akan Hadir:</h3>
              <ul className="text-sm text-yellow-700 space-y-1">
                <li>• Furniture custom</li>
                <li>• Plafon (gypsum, PVC)</li>
                <li>• Partisi</li>
                <li>• Finishing (cat, wallpaper)</li>
              </ul>
            </div>
            <Link 
              href="/products/kalkulator-harga"
