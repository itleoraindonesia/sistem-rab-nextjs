...
import { Package, Search, Plus, ExternalLink, FileDown, ChevronRight } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="space-y-6">
        ...
        {/* Table Container - matching the generic style often used */}
              ...
              <tbody>
                {filteredProjects.map((project, index) => (
                  <tr key={project.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 font-mono text-sm text-right text-gray-900">
                      {formatCurrency(project.contract_value)}
                    </td>
                    <td className="px-4 py-3 font-mono text-sm text-right text-gray-600">
              ...
              >
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono">{formatCurrency(project.contract_value)}</span>
                  </div>
