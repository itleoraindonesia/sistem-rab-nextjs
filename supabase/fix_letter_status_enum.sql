-- Fix submit_letter_for_review RPC to use correct enum values
-- Replace PENDING with SUBMITTED_TO_REVIEW
...
-- Also fix resubmit_revision RPC if it has similar issue
